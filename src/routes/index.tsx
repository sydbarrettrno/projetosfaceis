...
import { ArrowRight, ClipboardList, FileSearch, Home, ListChecks, ShieldCheck } from "lucide-react";
...
const VALUE_POINTS = [
  ...
  "Pendências prováveis e próximos passos visíveis",
  "Orientativo, sem promessa de aprovação",
];
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          <div className="max-w-2xl text-white">
            ...
            <h1 className="mt-4 text-3xl font-semibold leading-tight sm:text-5xl">
              Descubra possíveis pendências antes de protocolar seu projeto.
            </h1>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-white/85 sm:text-lg">
              Receba uma orientação preliminar, simples e objetiva, sem promessa de aprovação.
            </p>
        ...
        >
          ...
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            <Step
              ...
              title="Responda o essencial"
              description="Comece por quatro perguntas objetivas, sem informar contato."
            />
            <Step
              number="2"
              icon={<FileSearch className="h-5 w-5" />}
              title="Veja uma prévia"
              description="Confira o nível de atenção e quantas pendências prováveis foram encontradas."
            />
            <Step
              number="3"
              icon={<ShieldCheck className="h-5 w-5" />}
              title="Acesse o resultado"
              description="Informe seu contato para ver o resumo, as pendências e os próximos passos."
            />
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Projetos residenciais simples dependem de informações coerentes, documentos
                conferidos e decisões técnicas registradas. Nesta versão, o fluxo funcional
                permanece limitado a casa residencial unifamiliar simples.
              </p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <figure className="overflow-hidden rounded-lg border border-border bg-card">
                <img
                  src="/images/hero-casa-contemporanea.jpg"
                  alt="Casa residencial unifamiliar contemporânea"
                  className="aspect-[4/3] w-full object-cover"
                  loading="lazy"
                />
                <figcaption className="flex items-center gap-2 px-3 py-2 text-xs text-muted-foreground">
                  <Home className="h-3.5 w-3.5 text-primary" />
                  Projeto residencial simples
                </figcaption>
              </figure>
            </div>
          </div>
